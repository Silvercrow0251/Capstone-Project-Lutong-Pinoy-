...
import kotlinx.android.synthetic.main.activity_des_minatamis_na_saging.*
...
class DesMinatamisNaSaging : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_des_minatamis_na_saging)
