...
import kotlinx.android.synthetic.main.activity_des_biko.*
...
import kotlinx.android.synthetic.main.activity_des_buko_pie.*
...
class DesBukoPie : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_des_buko_pie)
