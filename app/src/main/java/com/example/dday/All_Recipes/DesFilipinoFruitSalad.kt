...
import kotlinx.android.synthetic.main.activity_des_filipino_fruit_salad.*
...
class DesFilipinoFruitSalad : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_des_filipino_fruit_salad)
