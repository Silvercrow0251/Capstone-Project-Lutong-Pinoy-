...
import kotlinx.android.synthetic.main.activity_br_cornsilog.*
import kotlinx.android.synthetic.main.activity_br_cornsilog.Utensils_items_6
...
class BrCornsilog : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_br_cornsilog)
