...
import kotlinx.android.synthetic.main.activity_item1.Recipe
...
import kotlinx.android.synthetic.main.activity_ln_lumpia.*

class LnLumpia : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ln_lumpia)
