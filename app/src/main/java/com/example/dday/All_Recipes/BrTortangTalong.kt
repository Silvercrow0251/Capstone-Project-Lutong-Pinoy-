...
import kotlinx.android.synthetic.main.activity_br_tortang_talong.*
...
class BrTortangTalong : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_br_tortang_talong)
