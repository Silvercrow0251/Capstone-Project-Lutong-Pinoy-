...
import kotlinx.android.synthetic.main.activity_des_leche_flan.*
...
class DesLecheFlan : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_des_leche_flan)
        ...
        copy.setOnClickListener {
            ...
            val clip = ClipData.newPlainText("TextView",
                ...
                textView.text.toString()+"\n"+"\n"+
                        ...
                        Utensils_items_8.text.toString()+"\n"+
                        Utensils_items_9.text.toString()+"\n"+
                        Utensils_items_10.text.toString()+"\n"+
                        Utensils_items_11.text.toString()+"\n"+"\n"+
