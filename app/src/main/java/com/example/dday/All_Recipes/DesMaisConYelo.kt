...
import kotlinx.android.synthetic.main.activity_des_mais_con_yelo.*
...
class DesMaisConYelo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_des_mais_con_yelo)
