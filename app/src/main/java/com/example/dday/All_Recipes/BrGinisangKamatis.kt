...
import kotlinx.android.synthetic.main.activity_br_ginisang_kamatis_at_itlog.*

class BrGinisangKamatis : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_br_ginisang_kamatis_at_itlog)
