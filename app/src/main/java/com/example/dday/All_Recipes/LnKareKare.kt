...
import kotlinx.android.synthetic.main.activity_item1.Ingredients_Item_10
import kotlinx.android.synthetic.main.activity_item1.Ingredients_Item_11
...
import kotlinx.android.synthetic.main.activity_item1.Ingredients_Item_9
...
import kotlinx.android.synthetic.main.activity_ln_kare_kare.*

class LnKareKare : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ln_kare_kare)
        ...
        copy.setOnClickListener {
            ...
            val clip = ClipData.newPlainText("TextView",
                ...
                textView.text.toString()+"\n"+"\n"+
                        ...
                        Utensils_items_6.text.toString()+"\n"+
                        Utensils_items_7.text.toString()+"\n"+"\n"+
                        ...
                        Ingredients_Item_12.text.toString()+"\n"+
                        Ingredients_Item_13.text.toString()+"\n"+
                        Ingredients_Item_14.text.toString()+"\n"+
                        Ingredients_Item_15.text.toString()+"\n"+
                        Ingredients_Item_16.text.toString()+"\n"+"\n"+
                        ...
                        Step8.text.toString()+"\n"+
                        Step_8.text.toString()+"\n"+"\n"+

                        Step9.text.toString()+"\n"+
                        Step_9.text.toString()+"\n"+"\n"+

                        Step10.text.toString()+"\n"+
                        Step_10.text.toString()+"\n"+"\n"+

                        Step11.text.toString()+"\n"+
                        Step_11.text.toString()+"\n"+"\n"+

                        Step12.text.toString()+"\n"+
                        Step_12.text.toString()+"\n"+"\n"+

                        Step13.text.toString()+"\n"+
                        Step_13.text.toString()+"\n"+"\n"+

                        Step14.text.toString()+"\n"+
                        Step_14.text.toString()+"\n"+"\n"+

                        Step15.text.toString()+"\n"+
                        Step_15.text.toString()+"\n"+"\n"+

                        Step16.text.toString()+"\n"+
                        Step_16.text.toString()+"\n"+"\n"+

                        Step17.text.toString()+"\n"+
                        Step_17.text.toString()+"\n"+"\n"+

                        Step18.text.toString()+"\n"+
                        Step_18.text.toString()+"\n"+"\n"+

                        Step19.text.toString()+"\n"+
                        Step_19.text.toString()+"\n"+"\n"+

                        Step20.text.toString()+"\n"+
                        Step_20.text.toString()+"\n"+"\n"+

                        Step21.text.toString()+"\n"+
                        Step_21.text.toString()+"\n"+"\n"+

                        Step22.text.toString()+"\n"+
                        Step_22.text.toString()+"\n"+"\n"+

                        Step23.text.toString()+"\n"+
                        Step_23.text.toString()+"\n"+"\n"+

                        Step24.text.toString()+"\n"+
                        Step_24.text.toString()+"\n"+"\n"+
