...
import kotlinx.android.synthetic.main.activity_br_daing_na_bangus.*
...
class BrDaingNaBangus : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_br_daing_na_bangus)
